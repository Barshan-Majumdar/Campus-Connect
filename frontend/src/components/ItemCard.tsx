...
export default function ItemCard({ title, category, state, owner, onClick }: ItemCardProps) {
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-xs font-medium text-brand-muted pl-2">Owner: <span className="text-slate-600">{owner}</span></p>
      </div>
